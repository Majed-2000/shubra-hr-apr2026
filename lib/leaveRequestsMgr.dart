...
class LeaverequestsMgr extends StatefulWidget {
  @override
  _LeaverequestsMgr createState() => _LeaverequestsMgr();
}

class _LeaverequestsMgr extends State<LeaverequestsMgr> {
  ...
  Future<void> _accept(Leave req) async {
    try {
      ...
      _snack(_extractError(e) ??
          bi(context, ar: "تعذّر تنفيذ العملية", en: "Operation failed"));
    } catch (e) {
      _snack(e.toString());
    }
  }
